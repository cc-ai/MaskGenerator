...
class MaskGenerator(BaseModel):
    ...
    def save_test_images(self, test_display_data, curr_iter, test = True):
        ...
        write_images(save_images, curr_iter, comet_exp=self.comet_exp, store_im=self.store_image, test = test)
